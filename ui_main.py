...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_minimize.setStyleSheet(Style.style_btn_minimize)
        icon = QIcon()
        icon.addFile(
        ...
        self.label_user_icon.setStyleSheet(Style.style_label_user_icon)
        ...
        self.page_widgets = PageWidget(sizePolicy)
        ...
        QWidget.setTabOrder(self.btn_toggle_menu, self.page_widgets)
